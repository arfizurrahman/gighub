...
namespace GigHub.Tests.Controllers.Api
{
    ...
    public class AttendancesControllerTests
    {
        ...
        public void Attend_UserAttendingAGigForWhichHeHasAttendance_ShouldReturnBadRequest()
        {
            ...
            var a = _userId;
            _mockRepository
                .Setup(r => r.GetAttendance(1, _userId))
                .Returns(attendance);
        ...
        [TestMethod]
        public void Attend_ValidRequest_ShouldReturnOkResult()
        {
            var result = _controller.Attend(new AttendanceDto() { GigId = 1 });
        ...
        [TestMethod]
        public void DeleteAttendance_NoAttendanceWithGivenId_ShouldReturnNotFound()
        {
